    ...
    <div className="animate-fadeIn">
      <div className="admin-pagehead">
        <div>
          ...
          <div className="sub">Configure global IGLA+ rules, roles, and configuration.</div>
        </div>
      </div>
      ...
      <div className="tile p-8 bg-white border-2 border-ink shadow-[4px_5px_0_#0d3a52] text-center max-w-lg mx-auto mt-8 select-none">
        <h3 className="font-display text-2xl text-ink font-normal mb-2">Settings Panel</h3>
        <p className="text-xs text-ink-3 leading-relaxed mb-6">
          This panel is scheduled for development in Phase 4. Here you will be able to manage admin user accounts, change age category rules, and adjust global configuration files.
        </p>
        <Link 
          href="/admin" 
